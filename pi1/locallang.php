<?php
/**
 * Language labels for plugin "tx_questionnaire_pi1"
 * 
...
$LOCAL_LANG = Array (
	"default" => Array (
		...
		"listFieldHeader_header" => "Header",	
		"listFieldHeader_questions" => "Questions",	
		"listFieldHeader_per_page" => "Questions per page",	
		"listFieldHeader_overview" => "Overview Page",	
		"list_mode_1" => "Mode 1",	
		"list_mode_2" => "Mode 2",	
		"list_mode_3" => "Mode 3",	
		"back" => "Back",	
